...
function Navbar() {
  ...
  const toggleDropdown = () => { setShown((prev) => !prev); $(".burger").toggleClass('not-active'); $(".burger").toggleClass('active'); };
        ...
        <div className="grid grid-cols-11 gap-x-0 ">
          ...
          <div className="nav-collapse hidden lg:col-start-3 col-span-10 lg:grid grid-cols-7 gap-0 content-center text-center">
            ...
            <div className="col-start-11 col-end-12 flex">
              <a className="self-center text-center px-3 font-Metric-Medium tracking-1px text-xs uppercase text-333 hover:text-A29F9A font-500">{Global.isLoggedIn ? "Logout" : "Sign up"}</a>
              <a className="self-center text-center px-3 font-Metric-Medium tracking-1px text-xs uppercase text-333 hover:text-A29F9A font-500">{Global.Items ? Global.Items : "0"} in cart</a>
          ...
          <div ref={dropdownRef} id="dropdown-menu" className="max-h-screen overflow-y-hidden lg:inline origin-top-right right-0 mt-0 w-56 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
            <div className="py-1" role="none">
              ...
              <a className="self-center text-center py-2 px-4 font-Metric-Medium tracking-1px text-xs uppercase text-333 hover:text-A29F9A font-500">{Global.isLoggedIn ? "Logout" : "Sign up"}</a>
              <a className="self-center text-center py-2 px-4 font-Metric-Medium tracking-1px text-xs uppercase text-333 hover:text-A29F9A font-500">{Global.Items ? Global.Items : "0"} in cart</a>
            </div>
          </div>
